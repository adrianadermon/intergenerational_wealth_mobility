...
label define intgraph 1 "a) 2nd on parents" 2 "b) 3rd on parents" 3 "c) 3rd on grandparents" 4 "d) 4th on parents" 5 "e) 4th on grandparents" 6 "f) 4th on great grandparents"
label values gen intgraph

* Save data for plotting in external program
saveold "data\workdata\plot_data.dta", version(13) replace
